...
class TX_OIP3_cpp: public TestClass {
public:
...
//		char *Test_Item[30], *Units[30];
		...
		FOREACH_ACTIVESITE_BEGIN(index, bInterrupt)
			...
			calc_WL_TX_OIP3(&RF_Test_Data,&ResultAttribute,pathloss[site_id], &Output_Power, &Result_oip3);
			...
			TheSoft.Flow().TestLimit(RF_CapPin,site_id, Result_oip3, lowl[1], hil[1],Hard_Bin[1],Soft_Bin[1], Units[1], Test_Item[1],Test_number[1]);
		FOREACH_ACTIVESITE_END

	}
};
REGISTER_TESTCLASS("TX_OIP3_cpp", TX_OIP3_cpp)
