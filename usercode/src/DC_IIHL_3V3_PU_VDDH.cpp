...
class DC_IIHL_3V3_PU_VDDH: public TestClass{
public:
	bool HBIN_FLAG[4];
...
//    		PPMUMethod_E method;
    	...
    	PinList pin[2] = {
    			{"gDC_IIHL_3V3_PU_VDDH_H",E_DC_FV_MI,3.63,5e-6,-5e-6,5e-6,E_MEASURE,100*us,E_MEASURE_ODER_GROUP},
				{"gDC_IIHL_3V3_PU_VDDH_L",E_DC_FV_MI,0,500e-6,-200e-6,100e-6,E_MEASURE,100*us,E_MEASURE_ODER_GROUP}
			};
...
REGISTER_TESTCLASS("DC_IIHL_3V3_PU_VDDH",DC_IIHL_3V3_PU_VDDH)
