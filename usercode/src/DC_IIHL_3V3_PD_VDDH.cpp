...
class DC_IIHL_3V3_PD_VDDH: public TestClass{
public:
	bool HBIN_FLAG[4];
...
//    		PPMUMethod_E method;
    	...
    	PinList pin[2] = {
    			{"gDC_IIHL_3V3_PD_VDDH_H",E_DC_FV_MI,3.63,500e-6,-100e-6,400e-6,E_MEASURE,10*ms,E_MEASURE_ODER_GROUP},
//    			{"gNORMAL_3V3_1V8_IO_PD",E_DC_FV_MI,3.63,500e-6,-100e-6,400e-6,E_MEASURE,10*ms,E_MEASURE_ODER_GROUP},
//    			{"gNORMAL_3V3_IO_PD",E_DC_FV_MI,1e-3,5e-6,-5e-6,5e-6,E_MEASURE,10*ms,E_MEASURE_ODER_GROUP},
    			{"gDC_IIHL_3V3_PD_VDDH_L",E_DC_FV_MI,1e-3,5e-6,-5e-6,5e-6,E_MEASURE,10*ms,E_MEASURE_ODER_GROUP}
			};
...
REGISTER_TESTCLASS("DC_IIHL_3V3_PD_VDDH",DC_IIHL_3V3_PD_VDDH)
