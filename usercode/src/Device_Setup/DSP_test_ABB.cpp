...
//        WriteData("ADC_I",data_i,FFT_Size);
//        WriteData("ADC_Q",data_q,FFT_Size);

    //    api->Set_curve_data("ADC_I", 0, 1/160e6, FFT_Size, data_i);   //打印FFT波形
    //    api->Set_curve_data("ADC_Q", 0, 1/160e6, FFT_Size, data_q);


//        MT_FFT(api, FFT_Size, data_i, data_i, Pfft_i);
//        MT_FFT(api, FFT_Size, data_q, data_q, Pfft_q);

        CCDSP::FFT(data_i,FFT_Size,Pfft_i,CCDSP::_0_Ohm);
        CCDSP::FFT(data_q,FFT_Size,Pfft_q,CCDSP::_0_Ohm);

//        WriteData("Pfft_i",Pfft_i,FFT_Size/2);
//        WriteData("Pfft_q",Pfft_q,FFT_Size/2);
...
//        WriteData("DAC_I",Inreal,FFT_Size);
//		WriteData("DAC_Q",Inimag,FFT_Size);
...
//        WriteData("DAC_I_FFT",SpectrumTemp_I,FFT_Size/2);
//		WriteData("DAC_Q_FFT",SpectrumTemp_Q,FFT_Size/2);
