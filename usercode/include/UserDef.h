...
extern int Get_Pin_Name(tyTestData Test_Data, char* SrcPinName, char* CapPinName, char* I_CapPinName_P = NULL, char* Q_CapPinName_P = NULL);
...
//extern int FFTFromIQData(IQMeasureAttribute *IQMeasData, int *Spectrum_I, int *Spectrum_Q);
